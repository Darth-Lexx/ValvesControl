...
void setup()
{
  ...
  display.fillRect(0, 10, 128, 22, WHITE);
  display.fillRect(0, 33, 128, 22, WHITE);
  display.fillRect(63, 10, 2, 45, BLACK);

  display.drawPixel(0 + CH_W - 1, 10, BLACK);
  display.drawPixel(0 + CH_W - 1, 33, BLACK);
  display.drawPixel(65 + CH_W - 1, 10, BLACK);
  display.drawPixel(65 + CH_W - 1, 33, BLACK);

  display.drawPixel(0, 10 + CH_H - 1, BLACK);
  display.drawPixel(0, 33 + CH_H - 1, BLACK);
  display.drawPixel(65, 10 + CH_H - 1, BLACK);
  display.drawPixel(65, 33 + CH_H - 1, BLACK);

  display.drawPixel(CH1_BR, BLACK);
  display.drawPixel(CH1_TL, BLACK);
  display.drawPixel(CH2_BR, BLACK);
  display.drawPixel(CH2_TL, BLACK);
  display.drawPixel(CH3_BR, BLACK);
  display.drawPixel(CH3_TL, BLACK);
  display.drawPixel(CH4_BR, BLACK);
  display.drawPixel(CH4_TL, BLACK);
